	...
	<Row gutter={16}>
		<Col xs={24} sm={24} md={17}>
			<Card title="User Create">
				...
				<Form.Item name="images" label="Image-Upload" rules={rules.images} value={addUser?.images}>
				<Dragger {...imageUploadProps} beforeUpload={beforeUpload}    
				value={addUser?.images}
				name="images"
				onChange = {(e)=>
					...
					props.handleUploadChange(e)
					  ...
					  setAddUser((pre)=>{
						return {...pre,images: e.file.name}
					  })
					}}
				>
					{
						props.uploadedImg ? 
						<img src={props.uploadedImg} name="images" alt="avatar" className="img-fluid" /> 
						: 
						<div>
							{
								props.uploadLoading ? 
